...
@section('content')
        ...
        <div class="navbar navbar-fixed-top">
            <div class="container-fluid cl">
                ...
                <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                    <ul class="cl">
                        <li>{{(auth('admin')->user()->id==1)?'超级管理员':auth('admin')->user()->role->role_name}}</li>
    ...
    <aside class="Hui-aside">
        <div class="menu_dropdown bk_2">
            @foreach($data as $val)
            <dl id="menu-article">
                <dt><i class="Hui-iconfont">{!! str_replace(['-','amp;'],'', $val['icon'])!!}</i> {{$val['node_name']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
                </dt>
                <dd>
                    <ul>
                        @forelse($val['children'] as $v)
                        <li><a data-href="{{route($v['route_name'])}}" data-title="{{$v['node_name']}}" href="javascript:void(0)">{{$v['node_name']}}</a></li>
                        @empty
                        @endforelse
                    </ul>
                </dd>
            ...
            {{--<dl id="menu-product">--}}
                ...
                {{--<dd>--}}
                    {{--<ul>--}}
                        {{--<li><a data-href="{{route('admin.brands.index')}}" data-title="品牌管理" href="javascript:void(0)">品牌管理</a></li>--}}
                        {{--<li><a data-href="{{route('admin.categories.index')}}" data-title="分类管理" href="javascript:void(0)">分类管理</a>--}}
                        {{--</li>--}}
                        {{--<li><a data-href="{{route('admin.goods.index')}}" data-title="商品列表" href="javascript:void(0)">商品列表</a></li>--}}
                        {{--<li><a data-href="{{route('admin.types.index')}}" data-title="类型管理" href="javascript:void(0)">商品类型</a></li>--}}
            ...
            {{--<dl id="menu-admin">--}}
                ...
                {{--<dd>--}}
                    {{--<ul>--}}
                        {{--<li><a data-href="{{route('admin.roles.index')}}" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>--}}
                        {{--<li><a data-href="{{route('admin.nodes.index')}}" data-title="权限管理" href="javascript:void(0)">权限管理</a>--}}
                        {{--</li>--}}
